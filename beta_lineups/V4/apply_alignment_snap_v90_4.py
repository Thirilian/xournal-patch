#!/usr/bin/env python3
"""
Patch 90.4 : version consolidee du processus alignment_snap actuel,
fusionnant v90 + 11.1 + 11.3 + 11.5 + 11.5.2 + 11.5.3 + 11.6 + 11.7 en
un seul script.

EXCLUT explicitement (a la demande de l'utilisateur) :
  - 11.2 et 11.2.2 (ajustements visuels de la double fleche du repere
    equidistant)
  - 11.4 et 11.4.2 (partage asymetrique 60/20/20 des zones Top/Middle/
    Below + desnappage - fonctionnalite mise de cote pour le moment)

Contenu (patchs fusionnes, dans l'ordre) :
  v90    : socle complet (7.11 a 10.10.5.1) - systeme d'accroche/
           alignement intelligent d'objets, onglet Preferences
           "Snapping" complet
  11.1   : correctif - guides des assistants coordinate system/circle
           assist toujours en trait plein
  11.3   : correctif - le verrouillage de graduation respecte
           desormais la validite reelle de la grille
  11.5   : gris du centrage de page eclairci + correctif de guideline
           rose manquante + nouveau repere rouge pour grille invalide
  11.5.2 : correctif - parametre largeur/hauteur inverse dans la
           verification de validite de grille (11.3/11.5)
  11.5.3 : une ligne de famille de graduation est desormais toujours
           rose, meme en mode Middle
  11.6   : correctif - point d'ancrage vertical des textboxes
           (asymetrie self/other + traitement du texte multi-lignes)
  11.7   : correctif - regression du 11.5.3 restreinte aux vraies
           petites graduations (longueur < Settings::getSmallMarkMaxLength())

NECESSITE : apply_arrow_resize_fix_v2.py (prerequis, applique AVANT ce
script)

A lancer depuis la racine du depot xournalpp, sur un depot vierge (ou
tout du moins sans qu'aucun patch individuel de la serie alignment_snap
n'ait deja ete applique).
"""
import sys
...
PO_XOURNALPP_POT_OLD0 = """\"you have the shape recognizer turned on while writing.\"
msgstr \"\"
...
msgstr \"\"
"""
PO_XOURNALPP_POT_NEW0 = """\"you have the shape recognizer turned on while writing.\"
msgstr \"\"
...
msgstr \"\"
"""
PO_XOURNALPP_POT_OLD1 = """#: ../resources-templates/com.github.xournalpp.xournalpp.xml.in:12
msgid \"Xournal++ page template file\"
msgstr \"\""""
PO_XOURNALPP_POT_NEW1 = """#: ../resources-templates/com.github.xournalpp.xournalpp.xml.in:12
msgid \"Xournal++ page template file\"
msgstr \"\"
...
msgid \"Settings\"
msgstr \"\""""
SRC_CORE_CONTROL_CONTROL_CPP_OLD0 = """    this->actionDB->setActionState(Action::GRID_SNAPPING, enable);
}

auto Control::getTextEditor() -> TextEditor* {
    if (this->win) {
        return this->win->getXournal()->getTextEditor();"""
SRC_CORE_CONTROL_CONTROL_CPP_NEW0 = """    this->actionDB->setActionState(Action::GRID_SNAPPING, enable);
}
...
SRC_CORE_CONTROL_CONTROL_H_NEW0 = """protected:
    ...
    void showFontDialog();
    void showColorChooserDialog();"""
SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H_OLD0 = """};
...
SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H_NEW0 = """};
...
struct ActionProperties<Action::PREFERENCES> {
    using app_namespace = std::true_type;
    static void callback(GSimpleAction*, GVariant*, Control* ctrl) { ctrl->showSettings(); }"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD0 = """    this->snapGrid = true;
    this->snapGridTolerance = 0.50;
    this->snapGridSize = DEFAULT_GRID_SIZE;

    this->strokeRecognizerMinSize = 40;
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW0 = """    this->snapGrid = true;
    this->snapGridTolerance = 0.50;
    this->snapGridSize = DEFAULT_GRID_SIZE;
    ...
    this->strokeRecognizerMinSize = 40;
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD1 = """        this->snapRotationTolerance = tempg_ascii_strtod(reinterpret_cast<const char*>(value), nullptr);
...
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW1 = """        this->snapRotationTolerance = tempg_ascii_strtod(reinterpret_cast<const char*>(value), nullptr);
    } else if (xmlStrcmp(name, reinterpret_cast<const xmlChar*>(\"snapGrid\")) == 0) {
        this->snapGrid = xmlStrcmp(value, reinterpret_cast<const xmlChar*>(\"true\")) == 0;
...
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD2 = """    SAVE_BOOL_PROP(snapGrid);
    SAVE_DOUBLE_PROP(snapGridTolerance);
    SAVE_DOUBLE_PROP(snapGridSize);

    SAVE_DOUBLE_PROP(strokeRecognizerMinSize);
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW2 = """    SAVE_BOOL_PROP(snapGrid);
    SAVE_DOUBLE_PROP(snapGridTolerance);
    SAVE_DOUBLE_PROP(snapGridSize);
    ...
    SAVE_DOUBLE_PROP(strokeRecognizerMinSize);
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD3 = """    save();
}

void Settings::setSnapGridTolerance(double tolerance) {
    this->snapGridTolerance = tolerance;
    save();"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW3 = """    save();
}
...
void Settings::setSnapGridTolerance(double tolerance) {
    this->snapGridTolerance = tolerance;
    save();"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_OLD0 = """    double getSnapGridSize() const;
    void setSnapGridSize(double gridSize);

    double getStrokeRecognizerMinSize() const;
    void setStrokeRecognizerMinSize(double value);
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_NEW0 = """    double getSnapGridSize() const;
    void setSnapGridSize(double gridSize);
    ...
    void setStrokeRecognizerMinSize(double value);
"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_OLD1 = """    bool snapGrid{};

    /**
     * Default name if you save a new document
     */
    std::u8string defaultSaveName;  // should be string - don't change to path"""
SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_NEW1 = """    bool snapGrid{};
     ...
     */
    std::u8string defaultSaveName;  // should be string - don't change to path"""
SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP_OLD0 = """auto ArrowHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
...
"""
SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP_NEW0 = """auto ArrowHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
    Point c = snappingHandler.snap(this->currPoint, this->startPoint, isAltDown);
    ...
    const ArrowKind kind = this->doubleEnded ? ArrowKind::DOUBLE : ArrowKind::SINGLE;
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD0 = """#include \"BaseShapeHandler.h\"

#include <cmath>   // for pow, NAN
#include <memory>  // for make_unique, __share...
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW0 = """#include \"BaseShapeHandler.h\"

#include <algorithm>  // for min, max
#include <cmath>   // for pow, NAN
#include <memory>  // for make_unique, __share...
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD1 = """#include \"view/overlays/ShapeToolView.h\"           // for ShapeToolView
...
BaseShapeHandler::BaseShapeHandler(Control* control, const PageRef& page, bool flipShift, bool flipControl):
        ...
        flipShift(flipShift),"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW1 = """#include \"view/overlays/ShapeToolView.h\"           // for ShapeToolView
...
BaseShapeHandler::BaseShapeHandler(Control* control, const PageRef& page, bool flipShift, bool flipControl):
        InputHandler(control, page),
        flipShift(flipShift),"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD2 = """void BaseShapeHandler::updateShape(bool isAltDown, bool isShiftDown, bool isControlDown) {
...
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW2 = """void BaseShapeHandler::updateShape(bool isAltDown, bool isShiftDown, bool isControlDown) {
    auto [shape, rg] = this->createShape(isAltDown, isShiftDown, isControlDown);
    std::swap(shape, this->shape);
    ...
    lastSnappingRange = rg;
    repaintRange.addPadding(0.5 * this->stroke->getWidth());"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD3 = """
...
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW3 = """
void BaseShapeHandler::cancelStroke() {
    this->shape.clear();
    ...
    repaintRange.addPadding(0.5 * this->stroke->getWidth());
    this->viewPool->dispatchAndClear(xoj::view::ShapeToolView::FINALIZATION_REQUEST, repaintRange);"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD4 = """        return true;
    }
    this->currPoint = newPoint;

    this->updateShape(pos.isAltDown(), pos.isShiftDown(), pos.isControlDown());
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW4 = """        return true;
    }
    this->currPoint = newPoint;
    this->lastZoom = zoom;
    ...
    this->updateShape(pos.isAltDown(), pos.isShiftDown(), pos.isControlDown());
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD5 = """
    ...
    repaintRange.addPadding(0.5 * this->stroke->getWidth());"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW5 = """
    stroke->setPointVector(this->shape, &lastSnappingRange);
    stroke->setArrowKind(this->getArrowKind());
    this->lineCrossingGuide.reset();
    this->diagonalSnapGuide.reset();
    ...
    Range repaintRange = lastSnappingRange;
    repaintRange.addPadding(0.5 * this->stroke->getWidth());"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD6 = """    }
}
...
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW6 = """    }
}
...
auto BaseShapeHandler::createView(xoj::view::Repaintable* parent) const -> std::unique_ptr<xoj::view::OverlayView> {"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD0 = """#pragma once

#include <memory>  // for shared_ptr
#include <utility>  // for pair
#include <vector>   // for vector
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW0 = """#pragma once
...
#include <vector>   // for vector
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD1 = """    const std::vector<Point>& getShape() const;
...
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW1 = """    const std::vector<Point>& getShape() const;
...
protected:
    std::vector<Point> shape;
"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD3 = """    Point buttonDownPoint;  // used for tapSelect and filtering - never snapped to grid.
    Point startPoint;       // May be snapped to grid

    std::shared_ptr<xoj::util::DispatchPool<xoj::view::ShapeToolView>> viewPool;
};"""
SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW3 = """    Point buttonDownPoint;  // used for tapSelect and filtering - never snapped to grid.
    Point startPoint;       // May be snapped to grid
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD0 = """#include \"gui/XournalppCursor.h\"                   // for XournalppCursor
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW0 = """#include \"gui/XournalppCursor.h\"                   // for XournalppCursor
#include \"model/Document.h\"                        // for Document
#include \"model/Element.h\"                         // for Element::Index
#include \"model/ElementInsertionPosition.h\"
#include \"model/Layer.h\"                          // for Layer
...
#include \"util/i18n.h\"                            // for _
#include \"util/serializing/ObjectInputStream.h\"   // for ObjectInputStream"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD1 = """constexpr int DELETE_PADDING = 20;
...
static auto computeBoxes(const InsertionOrder& elts) -> std::pair<Range, Range> {
    return std::transform_reduce(
            ...
            [](auto&& p, auto&& q) {"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW1 = """constexpr int DELETE_PADDING = 20;
constexpr int ROTATE_PADDING = 8;
...
static auto computeBoxes(const InsertionOrder& elts) -> std::pair<Range, Range> {
    return std::transform_reduce(
            elts.begin(), elts.end(), std::pair<Range, Range>(),
            [](auto&& p, auto&& q) {"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD2 = """EditSelection::EditSelection(Control* ctrl, InsertionOrder elts, const PageRef& page, Layer* layer, XojPageView* view,
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW2 = """EditSelection::EditSelection(Control* ctrl, InsertionOrder elts, const PageRef& page, Layer* layer, XojPageView* view,
                             const Range& bounds, const Range& snappingBounds):
        snappedBounds(snappingBounds),
        btnWidth(getBtnWidth(ctrl)),
        sourcePage(page),
    ...
    // make the visible bounding box large enough so that anchors do not collapse even for horizontal/vertical strokes
    const double PADDING = 12.;"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD3 = """
...
"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW3 = """
EditSelection::EditSelection(Control* ctrl, const PageRef& page, Layer* layer, XojPageView* view):
        snappedBounds(Rectangle<double>{}),
        btnWidth(getBtnWidth(ctrl)),
        sourcePage(page),
...
"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD4 = """}
...
"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW4 = """}
...
"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD5 = """    this->sourcePage = page;
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW5 = """    this->sourcePage = page;
    this->sourceLayer = layer;
...
void EditSelection::mouseDown(CursorSelectionType type, double x, double y) {
    ...
    // coordinates relative to top left corner of snapped bounds in coordinate system which is not modified"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD6 = """
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW6 = """
    // coordinates relative to top left corner of snapped bounds in coordinate system which is rotated to make bounding
    // box edges horizontal/vertical
    cairo_matrix_transform_point(&this->cmatrix, &x, &y);
    this->relMousePosRotX = x / zoom - this->snappedBounds.x;
...
void EditSelection::mouseMove(double mouseX, double mouseY, bool alt) {
    ...
    if (this->mouseDownType == CURSOR_SELECTION_MOVE) {
        ...
        if ((this->relMousePosRotX > this->snappedBounds.width / 2) ==
            (this->snappedBounds.width > 0)) {  // closer to the right side
            cx += this->snappedBounds.width;"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD7 = """        cx /= zoom;
        cy /= zoom;
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW7 = """        cx /= zoom;
        cy /= zoom;
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD8 = """}
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW8 = """}
...
void EditSelection::paint(cairo_t* cr, double zoom) {
    ...
    if (std::abs(this->rotation) > std::numeric_limits<double>::epsilon()) {"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD9 = """        cairo_translate(cr, -rx, -ry);
    }
...
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW9 = """        cairo_translate(cr, -rx, -ry);
    }
    this->contents->paint(cr, x, y, this->rotation, this->width, this->height, zoom);
    ...
    const std::vector<double> dashes = {10.0, 10.0};"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD0 = """
#include <array>
#include <memory>  // for unique_ptr
#include <string>
#include <utility>  // for pair
#include <vector>   // for vector"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW0 = """
#include <array>
#include <memory>  // for unique_ptr
#include <optional>
#include <string>
#include <utility>  // for pair
#include <vector>   // for vector"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD1 = """class DeleteUndoAction;
class LineStyle;
class ObjectInputStream;
class ObjectOutputStream;
class XojFont;
class Document;"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW1 = """class DeleteUndoAction;
class LineStyle;
class ObjectInputStream;
class Settings;
class ObjectOutputStream;
class XojFont;
class Document;"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD2 = """    Layer* sourceLayer{};

    /**
     * The contents of the selection
     */
    std::unique_ptr<EditSelectionContents> contents;"""
SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW2 = """    Layer* sourceLayer{};
     ...
     */
    std::unique_ptr<EditSelectionContents> contents;"""
SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP_OLD0 = """        width = (this->modControl) ? std::hypot(width, height) :
                                     std::copysign(std::max(std::abs(width), std::abs(height)), width);
        height = std::copysign(width, height);
    }

    double radiusX = 0;"""
SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP_NEW0 = """        width = (this->modControl) ? std::hypot(width, height) :
                                     std::copysign(std::max(std::abs(width), std::abs(height)), width);
        height = std::copysign(width, height);
    } else {
    ...
    double radiusX = 0;"""
SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP_OLD0 = """auto RulerHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
...
SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP_NEW0 = """auto RulerHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
    Point secondPoint = snappingHandler.snap(this->currPoint, this->startPoint, isAltDown);
    ...
    rg.addPoint(secondPoint.x, secondPoint.y);
    return {{this->startPoint, secondPoint}, rg};"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD0 = """
...
#include \"model/Stroke.h\"                        // for Stroke"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW0 = """
#include \"control/Control.h\"                       // for Control
#include \"control/layer/LayerController.h\"         // for LayerController
...
#include \"model/SplineSegment.h\"                 // for SplineSegment
#include \"model/Stroke.h\"                        // for Stroke"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD1 = """#include \"undo/UndoRedoHandler.h\"                // for UndoRedoHandler
#include \"util/Assert.h\"                         // for xoj_assert
#include \"util/DispatchPool.h\"
#include \"view/overlays/SplineToolView.h\"

SplineHandler::SplineHandler(Control* control, const PageRef& page):"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW1 = """#include \"undo/UndoRedoHandler.h\"                // for UndoRedoHandler
#include \"util/Assert.h\"                         // for xoj_assert
#include \"util/DispatchPool.h\"
...
SplineHandler::SplineHandler(Control* control, const PageRef& page):"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD2 = """}
...
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW2 = """}
...
constexpr double SCALE_AMOUNT = 1.05;
constexpr double MAX_TANGENT_LENGTH = 2000.0;"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD3 = """    return false;
}

auto SplineHandler::onMotionNotifyEvent(const PositionInputData& pos, double zoom) -> bool {
    if (!stroke) {
        return false;"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW3 = """    return false;
}
...
auto SplineHandler::onMotionNotifyEvent(const PositionInputData& pos, double zoom) -> bool {
    if (!stroke) {
        return false;"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD4 = """
    ...
    if (this->isButtonPressed) {
        if (this->inFirstKnotAttractionZone) {
            ...
            return true;"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW4 = """
    Range rg = this->computeLastSegmentRepaintRange();
    if (this->isButtonPressed) {
        ...
        if (this->inFirstKnotAttractionZone) {
            // The button was pressed within the attraction zone. Wait for unpress to confirm/deny spline finalization
            return true;"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD5 = """        bool nowInAttractionZone =
...
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW5 = """        bool nowInAttractionZone =
                this->buttonDownPoint.lineLengthTo(this->knots.front()) < this->knotsAttractionRadius;
        if (nowInAttractionZone) {
            this->activeGuideX.reset();
            this->activeGuideY.reset();
...
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD6 = """    if (this->knots.empty()) {
        return std::nullopt;
    }
...
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW6 = """    if (this->knots.empty()) {
        return std::nullopt;
    }
    return Data{this->knots,       this->tangents,   this->currPoint, this->knotsAttractionRadius,
...
auto SplineHandler::linearizeSpline(const SplineHandler::Data& data) -> std::vector<Point> {"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD0 = """};  // namespace xoj::view

/**
 * @brief Helper structure for communication with the views
 */
struct SplineHandlerData {"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW0 = """};  // namespace xoj::view
 ...
 */
struct SplineHandlerData {"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD1 = """    const Point& currPoint;
    double knotsAttractionRadius;
    bool closedSpline;
};

/**"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW1 = """    const Point& currPoint;
    double knotsAttractionRadius;
    bool closedSpline;
...
/**"""
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD2 = """    bool inFirstKnotAttractionZone = false;
...
SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW2 = """    bool inFirstKnotAttractionZone = false;
    SnapToGridInputHandler snappingHandler;
    ...
    static constexpr double KNOTS_ATTRACTION_RADIUS_IN_PIXELS = 10.0;  // for circling the spline's knots"""
SRC_CORE_ENUMS_ACTION_ENUM_H_OLD0 = """    MOVE_SELECTION_LAYER_DOWN,
    ROTATION_SNAPPING,
    GRID_SNAPPING,
    PREFERENCES,

    // Menu View"""
SRC_CORE_ENUMS_ACTION_ENUM_H_NEW0 = """    MOVE_SELECTION_LAYER_DOWN,
    ROTATION_SNAPPING,
    GRID_SNAPPING,
    ...
    // Menu View"""
SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H_OLD0 = """        \"move-selection-layer-down\",
        \"rotation-snapping\",
        \"grid-snapping\",
        \"preferences\",
        \"paired-pages-mode\",
        \"paired-pages-offset\","""
SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H_NEW0 = """        \"move-selection-layer-down\",
        \"rotation-snapping\",
        \"grid-snapping\",
        ...
        \"paired-pages-mode\",
        \"paired-pages-offset\","""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD0 = """            builder.get(\"cbAutosave\"), \"toggled\",
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW0 = """            builder.get(\"cbAutosave\"), \"toggled\",
            G_CALLBACK(+[](SettingsDialog* self) { self->enableWithCheckbox(\"cbAutosave\", \"boxAutosave\"); }), this);
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD1 = """    return gtk_range_get_value(range);
}

/**
 * Checkbox was toggled, enable / disable it
 */"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW1 = """    return gtk_range_get_value(range);
}
 ...
 * Checkbox was toggled, enable / disable it
 */"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD2 = """    loadCheckbox(\"cbShowScrollbarLeft\", settings->isScrollbarOnLeft());
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW2 = """    loadCheckbox(\"cbShowScrollbarLeft\", settings->isScrollbarOnLeft());
    loadCheckbox(\"cbAutoloadMostRecent\", settings->isAutoloadMostRecent());
    loadCheckbox(\"cbAutoloadXoj\", settings->isAutoloadPdfXoj());
    ...
    loadCheckbox(\"cbAddVerticalSpace\", settings->getAddVerticalSpace());
    loadCheckbox(\"cbAddHorizontalSpace\", settings->getAddHorizontalSpace());"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD3 = """    disableWithCheckbox(\"cbUnlimitedScrolling\", \"cbAddHorizontalSpace\");
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW3 = """    disableWithCheckbox(\"cbUnlimitedScrolling\", \"cbAddHorizontalSpace\");
    ...
    enableWithEnabledCheckbox(\"cbAddVerticalSpace\", \"spAddVerticalSpaceAbove\");
    enableWithEnabledCheckbox(\"cbAddHorizontalSpace\", \"spAddHorizontalSpaceRight\");"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD4 = """    settings->setScrollbarOnLeft(getCheckbox(\"cbShowScrollbarLeft\"));
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW4 = """    settings->setScrollbarOnLeft(getCheckbox(\"cbShowScrollbarLeft\"));
    settings->setAutoloadMostRecent(getCheckbox(\"cbAutoloadMostRecent\"));
    settings->setAutoloadPdfXoj(getCheckbox(\"cbAutoloadXoj\"));
    ...
    settings->setAddVerticalSpace(getCheckbox(\"cbAddVerticalSpace\"));
    settings->setAddHorizontalSpace(getCheckbox(\"cbAddHorizontalSpace\"));"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_OLD0 = """#pragma once

#include <functional>
#include <string>  // for string
#include <vector>  // for vector
"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_NEW0 = """#pragma once
...
#include <vector>  // for vector
"""
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_OLD1 = """    void loadSlider(const char* name, double value);
...
SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_NEW1 = """    void loadSlider(const char* name, double value);
    double getSlider(const char* name);
    ...
    void showStabilizerAvMethodOptions(StrokeStabilizer::AveragingMethod method);"""
SRC_CORE_MODEL_STROKE_CPP_OLD0 = """
...
"""
SRC_CORE_MODEL_STROKE_CPP_NEW0 = """
auto Stroke::getToolType() const -> StrokeTool { return this->toolType; }
...
auto Stroke::getArrowKind() const -> ArrowKind { return this->arrowKind; }
"""
SRC_CORE_MODEL_STROKE_CPP_OLD1 = """    Element::y = minY;
...
SRC_CORE_MODEL_STROKE_CPP_NEW1 = """    Element::y = minY;
    Element::width = maxX - minX;
    Element::height = maxY - minY;
...
auto Stroke::getErasable() const -> ErasableStroke* { return this->erasable; }"""
SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_OLD0 = """#include <vector>

#include \"control/tools/BaseShapeHandler.h\"
#include \"util/raii/CairoWrappers.h\"
#include \"view/Repaintable.h\"
#include \"view/StrokeViewHelper.h\""""
SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_NEW0 = """#include <vector>
...
#include \"view/Repaintable.h\"
#include \"view/StrokeViewHelper.h\""""
SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_OLD1 = """    StrokeViewHelper::pathToCairo(effCr, pts);

    this->commitDrawing(cr);
}

bool ShapeToolView::isViewOf(const OverlayBase* overlay) const { return overlay == this->toolHandler; }"""
SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_NEW1 = """    StrokeViewHelper::pathToCairo(effCr, pts);
...
bool ShapeToolView::isViewOf(const OverlayBase* overlay) const { return overlay == this->toolHandler; }"""
SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP_OLD0 = """    }
    cairo_stroke(cr);

    this->drawSpline(cr, data.value());
}
"""
SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP_NEW0 = """    }
    cairo_stroke(cr);
...
"""
UI_MAINMENUBAR_XML_OLD0 = """     <attribute name=\"label\" translatable=\"yes\">Grid Snapping</attribute>
     <attribute name=\"action\">win.grid-snapping</attribute>
    </item>
   </section>
   <section>
    <item>"""
UI_MAINMENUBAR_XML_NEW0 = """     <attribute name=\"label\" translatable=\"yes\">Grid Snapping</attribute>
     <attribute name=\"action\">win.grid-snapping</attribute>
    </item>
    <item>
   ...
   <section>
    <item>"""
UI_SETTINGS_GLADE_OLD0 = """              <packing>
...
UI_SETTINGS_GLADE_NEW0 = """              <packing>
                <property name=\"position\">7</property>
                <property name=\"tab-fill\">False</property>
              </packing>
            </child>
            ...
            <child>
              <object class=\"GtkBox\" id=\"toolsTabBox\">
                ...
                <property name=\"margin-start\">5</property>
                <property name=\"orientation\">vertical</property>"""
UI_SETTINGS_GLADE_OLD1 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
...
UI_SETTINGS_GLADE_NEW1 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"audioRecordingTabBox\">
                <property name=\"name\">audioRecordingTabBox</property>"""
UI_SETTINGS_GLADE_OLD2 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"latexTabBox\">
                <property name=\"visible\">True</property>"""
UI_SETTINGS_GLADE_NEW2 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"latexTabBox\">
                <property name=\"visible\">True</property>"""
UI_SETTINGS_GLADE_OLD3 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"paletteTabBox\">
                <property name=\"visible\">True</property>"""
UI_SETTINGS_GLADE_NEW3 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"paletteTabBox\">
                <property name=\"visible\">True</property>"""
UI_SETTINGS_GLADE_OLD4 = """                <property name=\"orientation\">vertical</property>
                <child>
                  <placeholder/>
                </child>
              </object>
          ...
          <packing>
            <property name=\"expand\">True</property>"""
UI_SETTINGS_GLADE_NEW4 = """                <property name=\"orientation\">vertical</property>
                <child>
                  <placeholder/>
                </child>
              </object>
...
def main():
    paths = {
        "PO_XOURNALPP_POT": Path("po/xournalpp.pot"),
        "SRC_CORE_CONTROL_CONTROL_CPP": Path("src/core/control/Control.cpp"),
        "SRC_CORE_CONTROL_CONTROL_H": Path("src/core/control/Control.h"),
        "SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H": Path("src/core/control/actions/ActionProperties.h"),
        "SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP": Path("src/core/control/settings/Settings.cpp"),
        "SRC_CORE_CONTROL_SETTINGS_SETTINGS_H": Path("src/core/control/settings/Settings.h"),
        "SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP": Path("src/core/control/tools/ArrowHandler.cpp"),
        "SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP": Path("src/core/control/tools/BaseShapeHandler.cpp"),
        "SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H": Path("src/core/control/tools/BaseShapeHandler.h"),
        "SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP": Path("src/core/control/tools/EditSelection.cpp"),
        "SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H": Path("src/core/control/tools/EditSelection.h"),
        "SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP": Path("src/core/control/tools/EllipseHandler.cpp"),
        "SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP": Path("src/core/control/tools/RulerHandler.cpp"),
        "SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP": Path("src/core/control/tools/SplineHandler.cpp"),
        "SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H": Path("src/core/control/tools/SplineHandler.h"),
        "SRC_CORE_ENUMS_ACTION_ENUM_H": Path("src/core/enums/Action.enum.h"),
        "SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H": Path("src/core/enums/generated/Action.NameMap.generated.h"),
        "SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP": Path("src/core/gui/dialog/SettingsDialog.cpp"),
        "SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H": Path("src/core/gui/dialog/SettingsDialog.h"),
        "SRC_CORE_MODEL_STROKE_CPP": Path("src/core/model/Stroke.cpp"),
        "SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP": Path("src/core/view/overlays/ShapeToolView.cpp"),
        "SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP": Path("src/core/view/overlays/SplineToolView.cpp"),
        "UI_MAINMENUBAR_XML": Path("ui/mainmenubar.xml"),
        "UI_SETTINGS_GLADE": Path("ui/settings.glade"),
    }
    ...
    if "Patch 11.7" in paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"].read_text(encoding="utf-8"):
        print("[SKIP] Ce patch consolide (90.4) semble deja applique.")
        sys.exit(0)
    ...
    for rel_path, content in NEW_FILES.items():
        ...
        if new_path.exists():
            print(f"[SKIP]  {rel_path}: fichier deja present.")
            continue
        new_path.parent.mkdir(parents=True, exist_ok=True)
        new_path.write_text(content, encoding="utf-8")
        print(f"[OK]    {rel_path}: fichier cree")

    ok &= apply_edit(paths["PO_XOURNALPP_POT"], PO_XOURNALPP_POT_OLD0, PO_XOURNALPP_POT_NEW0, "po/xournalpp.pot: zone 1/2")
    ok &= apply_edit(paths["PO_XOURNALPP_POT"], PO_XOURNALPP_POT_OLD1, PO_XOURNALPP_POT_NEW1, "po/xournalpp.pot: zone 2/2")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_CONTROL_CPP"], SRC_CORE_CONTROL_CONTROL_CPP_OLD0, SRC_CORE_CONTROL_CONTROL_CPP_NEW0, "src/core/control/Control.cpp: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_CONTROL_H"], SRC_CORE_CONTROL_CONTROL_H_OLD0, SRC_CORE_CONTROL_CONTROL_H_NEW0, "src/core/control/Control.h: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H"], SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H_OLD0, SRC_CORE_CONTROL_ACTIONS_ACTIONPROPERTIES_H_NEW0, "src/core/control/actions/ActionProperties.h: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD0, SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW0, "src/core/control/settings/Settings.cpp: zone 1/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD1, SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW1, "src/core/control/settings/Settings.cpp: zone 2/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD2, SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW2, "src/core/control/settings/Settings.cpp: zone 3/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_OLD3, SRC_CORE_CONTROL_SETTINGS_SETTINGS_CPP_NEW3, "src/core/control/settings/Settings.cpp: zone 4/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_H"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_OLD0, SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_NEW0, "src/core/control/settings/Settings.h: zone 1/2")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_SETTINGS_SETTINGS_H"], SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_OLD1, SRC_CORE_CONTROL_SETTINGS_SETTINGS_H_NEW1, "src/core/control/settings/Settings.h: zone 2/2")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_ARROWHANDLER_CPP_NEW0, "src/core/control/tools/ArrowHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW0, "src/core/control/tools/BaseShapeHandler.cpp: zone 1/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD1, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW1, "src/core/control/tools/BaseShapeHandler.cpp: zone 2/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD2, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW2, "src/core/control/tools/BaseShapeHandler.cpp: zone 3/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD3, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW3, "src/core/control/tools/BaseShapeHandler.cpp: zone 4/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD4, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW4, "src/core/control/tools/BaseShapeHandler.cpp: zone 5/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD5, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW5, "src/core/control/tools/BaseShapeHandler.cpp: zone 6/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_OLD6, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_CPP_NEW6, "src/core/control/tools/BaseShapeHandler.cpp: zone 7/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD0, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW0, "src/core/control/tools/BaseShapeHandler.h: zone 1/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD1, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW1, "src/core/control/tools/BaseShapeHandler.h: zone 2/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD2, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW2, "src/core/control/tools/BaseShapeHandler.h: zone 3/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_OLD3, SRC_CORE_CONTROL_TOOLS_BASESHAPEHANDLER_H_NEW3, "src/core/control/tools/BaseShapeHandler.h: zone 4/4")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW0, "src/core/control/tools/EditSelection.cpp: zone 1/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD1, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW1, "src/core/control/tools/EditSelection.cpp: zone 2/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD2, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW2, "src/core/control/tools/EditSelection.cpp: zone 3/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD3, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW3, "src/core/control/tools/EditSelection.cpp: zone 4/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD4, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW4, "src/core/control/tools/EditSelection.cpp: zone 5/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD5, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW5, "src/core/control/tools/EditSelection.cpp: zone 6/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD6, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW6, "src/core/control/tools/EditSelection.cpp: zone 7/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD7, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW7, "src/core/control/tools/EditSelection.cpp: zone 8/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD8, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW8, "src/core/control/tools/EditSelection.cpp: zone 9/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_OLD9, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_CPP_NEW9, "src/core/control/tools/EditSelection.cpp: zone 10/10")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD0, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW0, "src/core/control/tools/EditSelection.h: zone 1/3")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD1, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW1, "src/core/control/tools/EditSelection.h: zone 2/3")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H"], SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_OLD2, SRC_CORE_CONTROL_TOOLS_EDITSELECTION_H_NEW2, "src/core/control/tools/EditSelection.h: zone 3/3")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_ELLIPSEHANDLER_CPP_NEW0, "src/core/control/tools/EllipseHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_RULERHANDLER_CPP_NEW0, "src/core/control/tools/RulerHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD0, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW0, "src/core/control/tools/SplineHandler.cpp: zone 1/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD1, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW1, "src/core/control/tools/SplineHandler.cpp: zone 2/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD2, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW2, "src/core/control/tools/SplineHandler.cpp: zone 3/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD3, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW3, "src/core/control/tools/SplineHandler.cpp: zone 4/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD4, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW4, "src/core/control/tools/SplineHandler.cpp: zone 5/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD5, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW5, "src/core/control/tools/SplineHandler.cpp: zone 6/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_OLD6, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_CPP_NEW6, "src/core/control/tools/SplineHandler.cpp: zone 7/7")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD0, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW0, "src/core/control/tools/SplineHandler.h: zone 1/3")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD1, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW1, "src/core/control/tools/SplineHandler.h: zone 2/3")
    ok &= apply_edit(paths["SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H"], SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_OLD2, SRC_CORE_CONTROL_TOOLS_SPLINEHANDLER_H_NEW2, "src/core/control/tools/SplineHandler.h: zone 3/3")
    ok &= apply_edit(paths["SRC_CORE_ENUMS_ACTION_ENUM_H"], SRC_CORE_ENUMS_ACTION_ENUM_H_OLD0, SRC_CORE_ENUMS_ACTION_ENUM_H_NEW0, "src/core/enums/Action.enum.h: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H"], SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H_OLD0, SRC_CORE_ENUMS_GENERATED_ACTION_NAMEMAP_GENERATED_H_NEW0, "src/core/enums/generated/Action.NameMap.generated.h: zone 1/1")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD0, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW0, "src/core/gui/dialog/SettingsDialog.cpp: zone 1/5")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD1, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW1, "src/core/gui/dialog/SettingsDialog.cpp: zone 2/5")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD2, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW2, "src/core/gui/dialog/SettingsDialog.cpp: zone 3/5")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD3, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW3, "src/core/gui/dialog/SettingsDialog.cpp: zone 4/5")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_OLD4, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_CPP_NEW4, "src/core/gui/dialog/SettingsDialog.cpp: zone 5/5")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_OLD0, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_NEW0, "src/core/gui/dialog/SettingsDialog.h: zone 1/2")
    ok &= apply_edit(paths["SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H"], SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_OLD1, SRC_CORE_GUI_DIALOG_SETTINGSDIALOG_H_NEW1, "src/core/gui/dialog/SettingsDialog.h: zone 2/2")
    ok &= apply_edit(paths["SRC_CORE_MODEL_STROKE_CPP"], SRC_CORE_MODEL_STROKE_CPP_OLD0, SRC_CORE_MODEL_STROKE_CPP_NEW0, "src/core/model/Stroke.cpp: zone 1/2")
    ok &= apply_edit(paths["SRC_CORE_MODEL_STROKE_CPP"], SRC_CORE_MODEL_STROKE_CPP_OLD1, SRC_CORE_MODEL_STROKE_CPP_NEW1, "src/core/model/Stroke.cpp: zone 2/2")
    ok &= apply_edit(paths["SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP"], SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_OLD0, SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_NEW0, "src/core/view/overlays/ShapeToolView.cpp: zone 1/2")
    ok &= apply_edit(paths["SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP"], SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_OLD1, SRC_CORE_VIEW_OVERLAYS_SHAPETOOLVIEW_CPP_NEW1, "src/core/view/overlays/ShapeToolView.cpp: zone 2/2")
    ok &= apply_edit(paths["SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP"], SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP_OLD0, SRC_CORE_VIEW_OVERLAYS_SPLINETOOLVIEW_CPP_NEW0, "src/core/view/overlays/SplineToolView.cpp: zone 1/1")
    ok &= apply_edit(paths["UI_MAINMENUBAR_XML"], UI_MAINMENUBAR_XML_OLD0, UI_MAINMENUBAR_XML_NEW0, "ui/mainmenubar.xml: zone 1/1")
    ok &= apply_edit(paths["UI_SETTINGS_GLADE"], UI_SETTINGS_GLADE_OLD0, UI_SETTINGS_GLADE_NEW0, "ui/settings.glade: zone 1/5")
    ok &= apply_edit(paths["UI_SETTINGS_GLADE"], UI_SETTINGS_GLADE_OLD1, UI_SETTINGS_GLADE_NEW1, "ui/settings.glade: zone 2/5")
    ok &= apply_edit(paths["UI_SETTINGS_GLADE"], UI_SETTINGS_GLADE_OLD2, UI_SETTINGS_GLADE_NEW2, "ui/settings.glade: zone 3/5")
    ok &= apply_edit(paths["UI_SETTINGS_GLADE"], UI_SETTINGS_GLADE_OLD3, UI_SETTINGS_GLADE_NEW3, "ui/settings.glade: zone 4/5")
    ok &= apply_edit(paths["UI_SETTINGS_GLADE"], UI_SETTINGS_GLADE_OLD4, UI_SETTINGS_GLADE_NEW4, "ui/settings.glade: zone 5/5")
