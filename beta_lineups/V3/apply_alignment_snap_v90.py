#!/usr/bin/env python3
"""
Patch consolide (7.11 a 10.10.5.1) : regroupe l'integralite de la serie
de patchs "alignment snap" (systeme complet d'accroche/alignement
intelligent d'objets - paliers ordinaire/boost/equidistant/table/
graduation, assistants de croisement de ligne/cercle parfait/spline,
onglet Preferences "Snapping" avec 9 cases a cocher et 10 variables
numeriques configurables, template de traduction) en un seul script.

Remplace l'application sequentielle de :
  v7_11, v8_1_0, v8_2_0, v8_3_0, v8_4_0, v8_5_0, v8_6_A, v8_6_B,
  v8_6_B_2, v8_7_0, v8_9_0, v9_2, v10_1, v10_2, v10_3, v10_4, v10_5,
  v10_6A, v10_6A_2, v10_6B, v10_6B_2, v10_7, v10_9, v10_9_2, v10_10_1,
  v10_10_2_1 a v10_10_2_9, v10_10_3, v10_10_3_2, v10_10_4, v10_10_5_1
  (37 scripts au total)

par CE SEUL script, produisant un resultat identique byte pour byte.

NE remplace PAS apply_arrow_resize_fix_v2.py, qui reste un prerequis
separe a appliquer AVANT ce script.

Modifie 24 fichiers :
  po/xournalpp.pot
  src/core/control/Control.cpp, Control.h
  src/core/control/actions/ActionProperties.h
  src/core/control/settings/Settings.cpp, Settings.h
  src/core/control/tools/ArrowHandler.cpp, BaseShapeHandler.cpp/.h,
    EditSelection.cpp/.h, EllipseHandler.cpp, RulerHandler.cpp,
    SplineHandler.cpp/.h
  src/core/enums/Action.enum.h, generated/Action.NameMap.generated.h
  src/core/gui/dialog/SettingsDialog.cpp/.h
  src/core/model/Stroke.cpp
  src/core/view/overlays/ShapeToolView.cpp, SplineToolView.cpp
  ui/mainmenubar.xml, ui/settings.glade

A lancer depuis la racine du depot xournalpp, APRES
apply_arrow_resize_fix_v2.py, sur un depot vierge (aucun des 37 patchs
individuels ne doit avoir ete applique au prealable).
"""
import sys
...
POT_OLD0 = """\"you have the shape recognizer turned on while writing.\"
msgstr \"\"
...
msgstr \"\"
"""
POT_NEW0 = """\"you have the shape recognizer turned on while writing.\"
msgstr \"\"
...
msgstr \"\"
"""
POT_OLD1 = """#: ../resources-templates/com.github.xournalpp.xournalpp.xml.in:12
msgid \"Xournal++ page template file\"
msgstr \"\""""
POT_NEW1 = """#: ../resources-templates/com.github.xournalpp.xournalpp.xml.in:12
msgid \"Xournal++ page template file\"
msgstr \"\"
...
msgid \"Settings\"
msgstr \"\""""
CONTROL_CPP_OLD0 = """    this->actionDB->setActionState(Action::GRID_SNAPPING, enable);
}

auto Control::getTextEditor() -> TextEditor* {
    if (this->win) {
        return this->win->getXournal()->getTextEditor();"""
CONTROL_CPP_NEW0 = """    this->actionDB->setActionState(Action::GRID_SNAPPING, enable);
}
...
SETTINGS_H_NEW1 = """    bool snapGrid{};
     ...
     */
    std::u8string defaultSaveName;  // should be string - don't change to path"""
ARROWHANDLER_CPP_OLD0 = """auto ArrowHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
...
"""
ARROWHANDLER_CPP_NEW0 = """auto ArrowHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
    Point c = snappingHandler.snap(this->currPoint, this->startPoint, isAltDown);
    ...
    const ArrowKind kind = this->doubleEnded ? ArrowKind::DOUBLE : ArrowKind::SINGLE;
"""
BASESHAPE_CPP_OLD0 = """#include \"BaseShapeHandler.h\"

#include <cmath>   // for pow, NAN
#include <memory>  // for make_unique, __share...
"""
BASESHAPE_CPP_NEW0 = """#include \"BaseShapeHandler.h\"

#include <algorithm>  // for min, max
#include <cmath>   // for pow, NAN
#include <memory>  // for make_unique, __share...
"""
BASESHAPE_CPP_OLD1 = """#include \"view/overlays/ShapeToolView.h\"           // for ShapeToolView
...
BaseShapeHandler::BaseShapeHandler(Control* control, const PageRef& page, bool flipShift, bool flipControl):
        ...
        flipShift(flipShift),"""
BASESHAPE_CPP_NEW1 = """#include \"view/overlays/ShapeToolView.h\"           // for ShapeToolView
...
BaseShapeHandler::BaseShapeHandler(Control* control, const PageRef& page, bool flipShift, bool flipControl):
        InputHandler(control, page),
        flipShift(flipShift),"""
BASESHAPE_CPP_OLD2 = """void BaseShapeHandler::updateShape(bool isAltDown, bool isShiftDown, bool isControlDown) {
...
BASESHAPE_CPP_NEW2 = """void BaseShapeHandler::updateShape(bool isAltDown, bool isShiftDown, bool isControlDown) {
    auto [shape, rg] = this->createShape(isAltDown, isShiftDown, isControlDown);
    std::swap(shape, this->shape);
...
auto BaseShapeHandler::createView(xoj::view::Repaintable* parent) const -> std::unique_ptr<xoj::view::OverlayView> {"""
BASESHAPE_H_OLD0 = """#pragma once

#include <memory>  // for shared_ptr
#include <utility>  // for pair
#include <vector>   // for vector
"""
BASESHAPE_H_NEW0 = """#pragma once
...
#include <vector>   // for vector
"""
BASESHAPE_H_OLD1 = """    const std::vector<Point>& getShape() const;
...
BASESHAPE_H_NEW1 = """    const std::vector<Point>& getShape() const;
...
protected:
    std::vector<Point> shape;
"""
BASESHAPE_H_OLD3 = """    Point buttonDownPoint;  // used for tapSelect and filtering - never snapped to grid.
    Point startPoint;       // May be snapped to grid

    std::shared_ptr<xoj::util::DispatchPool<xoj::view::ShapeToolView>> viewPool;
};"""
BASESHAPE_H_NEW3 = """    Point buttonDownPoint;  // used for tapSelect and filtering - never snapped to grid.
    Point startPoint;       // May be snapped to grid
...
EDITSEL_CPP_OLD0 = """#include \"gui/XournalppCursor.h\"                   // for XournalppCursor
...
EDITSEL_CPP_NEW0 = """#include \"gui/XournalppCursor.h\"                   // for XournalppCursor
#include \"model/Document.h\"                        // for Document
#include \"model/Element.h\"                         // for Element::Index
#include \"model/ElementInsertionPosition.h\"
#include \"model/Layer.h\"                          // for Layer
...
#include \"util/i18n.h\"                            // for _
#include \"util/serializing/ObjectInputStream.h\"   // for ObjectInputStream"""
EDITSEL_CPP_OLD1 = """constexpr int DELETE_PADDING = 20;
...
static auto computeBoxes(const InsertionOrder& elts) -> std::pair<Range, Range> {
    return std::transform_reduce(
            ...
            [](auto&& p, auto&& q) {"""
EDITSEL_CPP_NEW1 = """constexpr int DELETE_PADDING = 20;
constexpr int ROTATE_PADDING = 8;
...
static auto computeBoxes(const InsertionOrder& elts) -> std::pair<Range, Range> {
    return std::transform_reduce(
            elts.begin(), elts.end(), std::pair<Range, Range>(),
            [](auto&& p, auto&& q) {"""
EDITSEL_CPP_OLD2 = """EditSelection::EditSelection(Control* ctrl, InsertionOrder elts, const PageRef& page, Layer* layer, XojPageView* view,
...
EDITSEL_CPP_NEW2 = """EditSelection::EditSelection(Control* ctrl, InsertionOrder elts, const PageRef& page, Layer* layer, XojPageView* view,
                             const Range& bounds, const Range& snappingBounds):
        snappedBounds(snappingBounds),
        btnWidth(getBtnWidth(ctrl)),
        sourcePage(page),
...
"""
EDITSEL_CPP_OLD5 = """    this->sourcePage = page;
...
EDITSEL_CPP_NEW5 = """    this->sourcePage = page;
    this->sourceLayer = layer;
...
static auto findAlignmentY(double y, double height, double xLeft, double xRight, double tolerance,
    ...
    for (auto& elPtr: layer->getElements()) {
        ...
        if (auto lineZone = detectLineZoneForOrdinaryAnchor(el, layer, excluded); lineZone && *lineZone != 0) {
...
void EditSelection::paint(cairo_t* cr, double zoom) {
    ...
    if (std::abs(this->rotation) > std::numeric_limits<double>::epsilon()) {"""
EDITSEL_CPP_OLD9 = """        cairo_translate(cr, -rx, -ry);
    }
...
EDITSEL_CPP_NEW9 = """        cairo_translate(cr, -rx, -ry);
    }
    this->contents->paint(cr, x, y, this->rotation, this->width, this->height, zoom);
...
#include <utility>  // for pair
#include <vector>   // for vector"""
EDITSEL_H_OLD1 = """class DeleteUndoAction;
class LineStyle;
class ObjectInputStream;
class ObjectOutputStream;
class XojFont;
class Document;"""
EDITSEL_H_NEW1 = """class DeleteUndoAction;
class LineStyle;
class ObjectInputStream;
class Settings;
class ObjectOutputStream;
class XojFont;
class Document;"""
EDITSEL_H_OLD2 = """    Layer* sourceLayer{};

    /**
     * The contents of the selection
     */
    std::unique_ptr<EditSelectionContents> contents;"""
EDITSEL_H_NEW2 = """    Layer* sourceLayer{};
     ...
     */
    std::unique_ptr<EditSelectionContents> contents;"""
ELLIPSE_CPP_OLD0 = """        width = (this->modControl) ? std::hypot(width, height) :
                                     std::copysign(std::max(std::abs(width), std::abs(height)), width);
        height = std::copysign(width, height);
    }

    double radiusX = 0;"""
ELLIPSE_CPP_NEW0 = """        width = (this->modControl) ? std::hypot(width, height) :
                                     std::copysign(std::max(std::abs(width), std::abs(height)), width);
        height = std::copysign(width, height);
    } else {
    ...
    double radiusX = 0;"""
RULER_CPP_OLD0 = """auto RulerHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
...
RULER_CPP_NEW0 = """auto RulerHandler::createShape(bool isAltDown, bool isShiftDown, bool isControlDown)
        -> std::pair<std::vector<Point>, Range> {
    Point secondPoint = snappingHandler.snap(this->currPoint, this->startPoint, isAltDown);
...
SPLINE_CPP_OLD6 = """    if (this->knots.empty()) {
        return std::nullopt;
    }
...
SPLINE_CPP_NEW6 = """    if (this->knots.empty()) {
        return std::nullopt;
    }
    return Data{this->knots,       this->tangents,   this->currPoint, this->knotsAttractionRadius,
...
SPLINE_H_NEW2 = """    bool inFirstKnotAttractionZone = false;
    ...
    static constexpr double KNOTS_ATTRACTION_RADIUS_IN_PIXELS = 10.0;  // for circling the spline's knots"""
ACTIONENUM_H_OLD0 = """    MOVE_SELECTION_LAYER_DOWN,
    ROTATION_SNAPPING,
    GRID_SNAPPING,
    PREFERENCES,

    // Menu View"""
ACTIONENUM_H_NEW0 = """    MOVE_SELECTION_LAYER_DOWN,
    ROTATION_SNAPPING,
    GRID_SNAPPING,
    ...
    // Menu View"""
ACTIONNAMEMAP_H_OLD0 = """        \"move-selection-layer-down\",
        \"rotation-snapping\",
        \"grid-snapping\",
        \"preferences\",
        \"paired-pages-mode\",
        \"paired-pages-offset\","""
ACTIONNAMEMAP_H_NEW0 = """        \"move-selection-layer-down\",
        \"rotation-snapping\",
        \"grid-snapping\",
        ...
        \"paired-pages-mode\",
        \"paired-pages-offset\","""
SETTINGSDIALOG_CPP_OLD0 = """            builder.get(\"cbAutosave\"), \"toggled\",
...
SETTINGSDIALOG_CPP_NEW0 = """            builder.get(\"cbAutosave\"), \"toggled\",
            G_CALLBACK(+[](SettingsDialog* self) { self->enableWithCheckbox(\"cbAutosave\", \"boxAutosave\"); }), this);
...
SETTINGSDIALOG_CPP_OLD1 = """    return gtk_range_get_value(range);
}

/**
 * Checkbox was toggled, enable / disable it
 */"""
SETTINGSDIALOG_CPP_NEW1 = """    return gtk_range_get_value(range);
}
 ...
 * Checkbox was toggled, enable / disable it
 */"""
SETTINGSDIALOG_CPP_OLD2 = """    loadCheckbox(\"cbShowScrollbarLeft\", settings->isScrollbarOnLeft());
...
SETTINGSDIALOG_CPP_NEW2 = """    loadCheckbox(\"cbShowScrollbarLeft\", settings->isScrollbarOnLeft());
    loadCheckbox(\"cbAutoloadMostRecent\", settings->isAutoloadMostRecent());
    loadCheckbox(\"cbAutoloadXoj\", settings->isAutoloadPdfXoj());
    ...
    loadCheckbox(\"cbAddVerticalSpace\", settings->getAddVerticalSpace());
    loadCheckbox(\"cbAddHorizontalSpace\", settings->getAddHorizontalSpace());"""
SETTINGSDIALOG_CPP_OLD3 = """    disableWithCheckbox(\"cbUnlimitedScrolling\", \"cbAddHorizontalSpace\");
...
SETTINGSDIALOG_CPP_NEW3 = """    disableWithCheckbox(\"cbUnlimitedScrolling\", \"cbAddHorizontalSpace\");
    ...
    enableWithEnabledCheckbox(\"cbAddVerticalSpace\", \"spAddVerticalSpaceAbove\");
    enableWithEnabledCheckbox(\"cbAddHorizontalSpace\", \"spAddHorizontalSpaceRight\");"""
SETTINGSDIALOG_CPP_OLD4 = """    settings->setScrollbarOnLeft(getCheckbox(\"cbShowScrollbarLeft\"));
...
SETTINGSDIALOG_CPP_NEW4 = """    settings->setScrollbarOnLeft(getCheckbox(\"cbShowScrollbarLeft\"));
    settings->setAutoloadMostRecent(getCheckbox(\"cbAutoloadMostRecent\"));
    settings->setAutoloadPdfXoj(getCheckbox(\"cbAutoloadXoj\"));
    ...
    settings->setAddVerticalSpace(getCheckbox(\"cbAddVerticalSpace\"));
    settings->setAddHorizontalSpace(getCheckbox(\"cbAddHorizontalSpace\"));"""
SETTINGSDIALOG_H_OLD0 = """#pragma once

#include <functional>
#include <string>  // for string
#include <vector>  // for vector
"""
SETTINGSDIALOG_H_NEW0 = """#pragma once
...
#include <vector>  // for vector
"""
SETTINGSDIALOG_H_OLD1 = """    void loadSlider(const char* name, double value);
...
SETTINGSDIALOG_H_NEW1 = """    void loadSlider(const char* name, double value);
    double getSlider(const char* name);
...
auto Stroke::getArrowKind() const -> ArrowKind { return this->arrowKind; }
"""
STROKE_CPP_OLD1 = """    Element::y = minY;
...
STROKE_CPP_NEW1 = """    Element::y = minY;
    Element::width = maxX - minX;
    Element::height = maxY - minY;
...
#include \"view/Repaintable.h\"
#include \"view/StrokeViewHelper.h\""""
SHAPETOOLVIEW_CPP_OLD1 = """    StrokeViewHelper::pathToCairo(effCr, pts);

    this->commitDrawing(cr);
}

bool ShapeToolView::isViewOf(const OverlayBase* overlay) const { return overlay == this->toolHandler; }"""
SHAPETOOLVIEW_CPP_NEW1 = """    StrokeViewHelper::pathToCairo(effCr, pts);
...
bool ShapeToolView::isViewOf(const OverlayBase* overlay) const { return overlay == this->toolHandler; }"""
SPLINETOOLVIEW_CPP_OLD0 = """    }
    cairo_stroke(cr);

    this->drawSpline(cr, data.value());
}
"""
SPLINETOOLVIEW_CPP_NEW0 = """    }
    cairo_stroke(cr);
...
"""
MAINMENUBAR_XML_OLD0 = """     <attribute name=\"label\" translatable=\"yes\">Grid Snapping</attribute>
     <attribute name=\"action\">win.grid-snapping</attribute>
    </item>
   </section>
   <section>
    <item>"""
MAINMENUBAR_XML_NEW0 = """     <attribute name=\"label\" translatable=\"yes\">Grid Snapping</attribute>
     <attribute name=\"action\">win.grid-snapping</attribute>
    </item>
    <item>
...
SETTINGS_GLADE_NEW0 = """              <packing>
            ...
            <child>
              <object class=\"GtkBox\" id=\"toolsTabBox\">
                ...
                <property name=\"margin-start\">5</property>
                <property name=\"orientation\">vertical</property>"""
SETTINGS_GLADE_OLD1 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
...
SETTINGS_GLADE_NEW1 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"audioRecordingTabBox\">
                <property name=\"name\">audioRecordingTabBox</property>"""
SETTINGS_GLADE_OLD2 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"latexTabBox\">
                <property name=\"visible\">True</property>"""
SETTINGS_GLADE_NEW2 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"latexTabBox\">
                <property name=\"visible\">True</property>"""
SETTINGS_GLADE_OLD3 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"paletteTabBox\">
                <property name=\"visible\">True</property>"""
SETTINGS_GLADE_NEW3 = """                    <property name=\"fill\">True</property>
                    <property name=\"position\">0</property>
                  </packing>
                </child>
              </object>
            ...
            <child>
              <object class=\"GtkBox\" id=\"paletteTabBox\">
                <property name=\"visible\">True</property>"""
SETTINGS_GLADE_OLD4 = """                <property name=\"orientation\">vertical</property>
                <child>
                  <placeholder/>
                </child>
              </object>
          ...
          <packing>
            <property name=\"expand\">True</property>"""
SETTINGS_GLADE_NEW4 = """                <property name=\"orientation\">vertical</property>
                <child>
                  <placeholder/>
                </child>
              </object>
...
def main():
    paths = {
        ...
        "CONTROL_H": Path("src/core/control/Control.h"),
        "ACTIONPROPS_H": Path("src/core/control/actions/ActionProperties.h"),
        "SETTINGS_CPP": Path("src/core/control/settings/Settings.cpp"),
        "SETTINGS_H": Path("src/core/control/settings/Settings.h"),
        "ARROWHANDLER_CPP": Path("src/core/control/tools/ArrowHandler.cpp"),
        "BASESHAPE_CPP": Path("src/core/control/tools/BaseShapeHandler.cpp"),
        "BASESHAPE_H": Path("src/core/control/tools/BaseShapeHandler.h"),
        "EDITSEL_CPP": Path("src/core/control/tools/EditSelection.cpp"),
        "EDITSEL_H": Path("src/core/control/tools/EditSelection.h"),
        "ELLIPSE_CPP": Path("src/core/control/tools/EllipseHandler.cpp"),
        "RULER_CPP": Path("src/core/control/tools/RulerHandler.cpp"),
        "SPLINE_CPP": Path("src/core/control/tools/SplineHandler.cpp"),
        "SPLINE_H": Path("src/core/control/tools/SplineHandler.h"),
        "ACTIONENUM_H": Path("src/core/enums/Action.enum.h"),
        "ACTIONNAMEMAP_H": Path("src/core/enums/generated/Action.NameMap.generated.h"),
        "SETTINGSDIALOG_CPP": Path("src/core/gui/dialog/SettingsDialog.cpp"),
        "SETTINGSDIALOG_H": Path("src/core/gui/dialog/SettingsDialog.h"),
        "STROKE_CPP": Path("src/core/model/Stroke.cpp"),
        "SHAPETOOLVIEW_CPP": Path("src/core/view/overlays/ShapeToolView.cpp"),
        "SPLINETOOLVIEW_CPP": Path("src/core/view/overlays/SplineToolView.cpp"),
        "MAINMENUBAR_XML": Path("ui/mainmenubar.xml"),
        "SETTINGS_GLADE": Path("ui/settings.glade"),
    }
    ...
    if "ALIGNMENT_GROUP_TOLERANCE_PX" in paths["EDITSEL_CPP"].read_text(encoding="utf-8"):
        print("[SKIP] Ce patch consolide semble deja applique (ou un patch individuel de la serie l'est).")
        sys.exit(0)
    ...
    ok = True
    ok &= apply_edit(paths["POT"], POT_OLD0, POT_NEW0, "po/xournalpp.pot: zone 1/2")
    ok &= apply_edit(paths["POT"], POT_OLD1, POT_NEW1, "po/xournalpp.pot: zone 2/2")
    ok &= apply_edit(paths["CONTROL_CPP"], CONTROL_CPP_OLD0, CONTROL_CPP_NEW0, "src/core/control/Control.cpp: zone 1/1")
    ok &= apply_edit(paths["CONTROL_H"], CONTROL_H_OLD0, CONTROL_H_NEW0, "src/core/control/Control.h: zone 1/1")
    ok &= apply_edit(paths["ACTIONPROPS_H"], ACTIONPROPS_H_OLD0, ACTIONPROPS_H_NEW0, "src/core/control/actions/ActionProperties.h: zone 1/1")
    ok &= apply_edit(paths["SETTINGS_CPP"], SETTINGS_CPP_OLD0, SETTINGS_CPP_NEW0, "src/core/control/settings/Settings.cpp: zone 1/4")
    ok &= apply_edit(paths["SETTINGS_CPP"], SETTINGS_CPP_OLD1, SETTINGS_CPP_NEW1, "src/core/control/settings/Settings.cpp: zone 2/4")
    ok &= apply_edit(paths["SETTINGS_CPP"], SETTINGS_CPP_OLD2, SETTINGS_CPP_NEW2, "src/core/control/settings/Settings.cpp: zone 3/4")
    ok &= apply_edit(paths["SETTINGS_CPP"], SETTINGS_CPP_OLD3, SETTINGS_CPP_NEW3, "src/core/control/settings/Settings.cpp: zone 4/4")
    ok &= apply_edit(paths["SETTINGS_H"], SETTINGS_H_OLD0, SETTINGS_H_NEW0, "src/core/control/settings/Settings.h: zone 1/2")
    ok &= apply_edit(paths["SETTINGS_H"], SETTINGS_H_OLD1, SETTINGS_H_NEW1, "src/core/control/settings/Settings.h: zone 2/2")
    ok &= apply_edit(paths["ARROWHANDLER_CPP"], ARROWHANDLER_CPP_OLD0, ARROWHANDLER_CPP_NEW0, "src/core/control/tools/ArrowHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD0, BASESHAPE_CPP_NEW0, "src/core/control/tools/BaseShapeHandler.cpp: zone 1/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD1, BASESHAPE_CPP_NEW1, "src/core/control/tools/BaseShapeHandler.cpp: zone 2/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD2, BASESHAPE_CPP_NEW2, "src/core/control/tools/BaseShapeHandler.cpp: zone 3/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD3, BASESHAPE_CPP_NEW3, "src/core/control/tools/BaseShapeHandler.cpp: zone 4/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD4, BASESHAPE_CPP_NEW4, "src/core/control/tools/BaseShapeHandler.cpp: zone 5/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD5, BASESHAPE_CPP_NEW5, "src/core/control/tools/BaseShapeHandler.cpp: zone 6/7")
    ok &= apply_edit(paths["BASESHAPE_CPP"], BASESHAPE_CPP_OLD6, BASESHAPE_CPP_NEW6, "src/core/control/tools/BaseShapeHandler.cpp: zone 7/7")
    ok &= apply_edit(paths["BASESHAPE_H"], BASESHAPE_H_OLD0, BASESHAPE_H_NEW0, "src/core/control/tools/BaseShapeHandler.h: zone 1/4")
    ok &= apply_edit(paths["BASESHAPE_H"], BASESHAPE_H_OLD1, BASESHAPE_H_NEW1, "src/core/control/tools/BaseShapeHandler.h: zone 2/4")
    ok &= apply_edit(paths["BASESHAPE_H"], BASESHAPE_H_OLD2, BASESHAPE_H_NEW2, "src/core/control/tools/BaseShapeHandler.h: zone 3/4")
    ok &= apply_edit(paths["BASESHAPE_H"], BASESHAPE_H_OLD3, BASESHAPE_H_NEW3, "src/core/control/tools/BaseShapeHandler.h: zone 4/4")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD0, EDITSEL_CPP_NEW0, "src/core/control/tools/EditSelection.cpp: zone 1/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD1, EDITSEL_CPP_NEW1, "src/core/control/tools/EditSelection.cpp: zone 2/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD2, EDITSEL_CPP_NEW2, "src/core/control/tools/EditSelection.cpp: zone 3/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD3, EDITSEL_CPP_NEW3, "src/core/control/tools/EditSelection.cpp: zone 4/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD4, EDITSEL_CPP_NEW4, "src/core/control/tools/EditSelection.cpp: zone 5/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD5, EDITSEL_CPP_NEW5, "src/core/control/tools/EditSelection.cpp: zone 6/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD6, EDITSEL_CPP_NEW6, "src/core/control/tools/EditSelection.cpp: zone 7/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD7, EDITSEL_CPP_NEW7, "src/core/control/tools/EditSelection.cpp: zone 8/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD8, EDITSEL_CPP_NEW8, "src/core/control/tools/EditSelection.cpp: zone 9/10")
    ok &= apply_edit(paths["EDITSEL_CPP"], EDITSEL_CPP_OLD9, EDITSEL_CPP_NEW9, "src/core/control/tools/EditSelection.cpp: zone 10/10")
    ok &= apply_edit(paths["EDITSEL_H"], EDITSEL_H_OLD0, EDITSEL_H_NEW0, "src/core/control/tools/EditSelection.h: zone 1/3")
    ok &= apply_edit(paths["EDITSEL_H"], EDITSEL_H_OLD1, EDITSEL_H_NEW1, "src/core/control/tools/EditSelection.h: zone 2/3")
    ok &= apply_edit(paths["EDITSEL_H"], EDITSEL_H_OLD2, EDITSEL_H_NEW2, "src/core/control/tools/EditSelection.h: zone 3/3")
    ok &= apply_edit(paths["ELLIPSE_CPP"], ELLIPSE_CPP_OLD0, ELLIPSE_CPP_NEW0, "src/core/control/tools/EllipseHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["RULER_CPP"], RULER_CPP_OLD0, RULER_CPP_NEW0, "src/core/control/tools/RulerHandler.cpp: zone 1/1")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD0, SPLINE_CPP_NEW0, "src/core/control/tools/SplineHandler.cpp: zone 1/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD1, SPLINE_CPP_NEW1, "src/core/control/tools/SplineHandler.cpp: zone 2/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD2, SPLINE_CPP_NEW2, "src/core/control/tools/SplineHandler.cpp: zone 3/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD3, SPLINE_CPP_NEW3, "src/core/control/tools/SplineHandler.cpp: zone 4/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD4, SPLINE_CPP_NEW4, "src/core/control/tools/SplineHandler.cpp: zone 5/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD5, SPLINE_CPP_NEW5, "src/core/control/tools/SplineHandler.cpp: zone 6/7")
    ok &= apply_edit(paths["SPLINE_CPP"], SPLINE_CPP_OLD6, SPLINE_CPP_NEW6, "src/core/control/tools/SplineHandler.cpp: zone 7/7")
    ok &= apply_edit(paths["SPLINE_H"], SPLINE_H_OLD0, SPLINE_H_NEW0, "src/core/control/tools/SplineHandler.h: zone 1/3")
    ok &= apply_edit(paths["SPLINE_H"], SPLINE_H_OLD1, SPLINE_H_NEW1, "src/core/control/tools/SplineHandler.h: zone 2/3")
    ok &= apply_edit(paths["SPLINE_H"], SPLINE_H_OLD2, SPLINE_H_NEW2, "src/core/control/tools/SplineHandler.h: zone 3/3")
    ok &= apply_edit(paths["ACTIONENUM_H"], ACTIONENUM_H_OLD0, ACTIONENUM_H_NEW0, "src/core/enums/Action.enum.h: zone 1/1")
    ok &= apply_edit(paths["ACTIONNAMEMAP_H"], ACTIONNAMEMAP_H_OLD0, ACTIONNAMEMAP_H_NEW0, "src/core/enums/generated/Action.NameMap.generated.h: zone 1/1")
    ok &= apply_edit(paths["SETTINGSDIALOG_CPP"], SETTINGSDIALOG_CPP_OLD0, SETTINGSDIALOG_CPP_NEW0, "src/core/gui/dialog/SettingsDialog.cpp: zone 1/5")
    ok &= apply_edit(paths["SETTINGSDIALOG_CPP"], SETTINGSDIALOG_CPP_OLD1, SETTINGSDIALOG_CPP_NEW1, "src/core/gui/dialog/SettingsDialog.cpp: zone 2/5")
    ok &= apply_edit(paths["SETTINGSDIALOG_CPP"], SETTINGSDIALOG_CPP_OLD2, SETTINGSDIALOG_CPP_NEW2, "src/core/gui/dialog/SettingsDialog.cpp: zone 3/5")
    ok &= apply_edit(paths["SETTINGSDIALOG_CPP"], SETTINGSDIALOG_CPP_OLD3, SETTINGSDIALOG_CPP_NEW3, "src/core/gui/dialog/SettingsDialog.cpp: zone 4/5")
    ok &= apply_edit(paths["SETTINGSDIALOG_CPP"], SETTINGSDIALOG_CPP_OLD4, SETTINGSDIALOG_CPP_NEW4, "src/core/gui/dialog/SettingsDialog.cpp: zone 5/5")
    ok &= apply_edit(paths["SETTINGSDIALOG_H"], SETTINGSDIALOG_H_OLD0, SETTINGSDIALOG_H_NEW0, "src/core/gui/dialog/SettingsDialog.h: zone 1/2")
    ok &= apply_edit(paths["SETTINGSDIALOG_H"], SETTINGSDIALOG_H_OLD1, SETTINGSDIALOG_H_NEW1, "src/core/gui/dialog/SettingsDialog.h: zone 2/2")
    ok &= apply_edit(paths["STROKE_CPP"], STROKE_CPP_OLD0, STROKE_CPP_NEW0, "src/core/model/Stroke.cpp: zone 1/2")
    ok &= apply_edit(paths["STROKE_CPP"], STROKE_CPP_OLD1, STROKE_CPP_NEW1, "src/core/model/Stroke.cpp: zone 2/2")
    ok &= apply_edit(paths["SHAPETOOLVIEW_CPP"], SHAPETOOLVIEW_CPP_OLD0, SHAPETOOLVIEW_CPP_NEW0, "src/core/view/overlays/ShapeToolView.cpp: zone 1/2")
    ok &= apply_edit(paths["SHAPETOOLVIEW_CPP"], SHAPETOOLVIEW_CPP_OLD1, SHAPETOOLVIEW_CPP_NEW1, "src/core/view/overlays/ShapeToolView.cpp: zone 2/2")
    ok &= apply_edit(paths["SPLINETOOLVIEW_CPP"], SPLINETOOLVIEW_CPP_OLD0, SPLINETOOLVIEW_CPP_NEW0, "src/core/view/overlays/SplineToolView.cpp: zone 1/1")
    ok &= apply_edit(paths["MAINMENUBAR_XML"], MAINMENUBAR_XML_OLD0, MAINMENUBAR_XML_NEW0, "ui/mainmenubar.xml: zone 1/1")
    ok &= apply_edit(paths["SETTINGS_GLADE"], SETTINGS_GLADE_OLD0, SETTINGS_GLADE_NEW0, "ui/settings.glade: zone 1/5")
    ok &= apply_edit(paths["SETTINGS_GLADE"], SETTINGS_GLADE_OLD1, SETTINGS_GLADE_NEW1, "ui/settings.glade: zone 2/5")
    ok &= apply_edit(paths["SETTINGS_GLADE"], SETTINGS_GLADE_OLD2, SETTINGS_GLADE_NEW2, "ui/settings.glade: zone 3/5")
    ok &= apply_edit(paths["SETTINGS_GLADE"], SETTINGS_GLADE_OLD3, SETTINGS_GLADE_NEW3, "ui/settings.glade: zone 4/5")
    ok &= apply_edit(paths["SETTINGS_GLADE"], SETTINGS_GLADE_OLD4, SETTINGS_GLADE_NEW4, "ui/settings.glade: zone 5/5")
