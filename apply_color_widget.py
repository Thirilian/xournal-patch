#!/usr/bin/env python3
"""
Ajoute un bouton de couleur directement dans la fenetre d'edition LaTeX,
pour pouvoir changer %%XPP_TEXT_COLOR%% (la couleur de l'outil TOOL_LATEX)
sans avoir a fermer le dialogue modal. Le changement de couleur declenche
automatiquement une recompilation.
...
def main():
    ...
    # --- ui/intEdTexDialog.glade : ajout du GtkColorButton ---
    ...
    # --- IntEdLatexDialog.cpp : initialisation + wiring du bouton ---
    ok &= apply_edit(
        fc,
